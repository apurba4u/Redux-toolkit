const ResultCard = ({ elem }) => {
  ...
  return (
    <div className="w-[20vw] relative h-80 bg-white rounded-xl overflow-hidden">
      ...
      <div
        id="bottom"
        className="flex justify-between gap-2 items-center absolute h-[35%] w-full px-4 py-6 placeholder-cyan-100 text-white bottom-0 "
      >
        ...
        <button
          ...
          className=" border-2 border-blue-500 cursor-pointer p-3 font-medium text-white active:scale-95 rounded"
        >
          {" "}
          save
        </button>
